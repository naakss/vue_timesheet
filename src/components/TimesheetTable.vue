        ...
        <v-toolbar flat color="white">
          ...
          <v-dialog v-model="clearDialog" max-width="500px">
            <v-card>
              ...
              <v-card-text
                >Are you sure to clear the selected item?</v-card-text
              >
